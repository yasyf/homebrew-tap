...
cask "cc-pool-status" do
  version "0.61.4"
  sha256 "30109bf9118fc488c2ef62abc0da8a4c5def167efc1868fecba9df268f2a28e3" # app

  url "https://github.com/yasyf/cc-pool/releases/download/v0.61.4/cc-pool-status-v0.61.4-darwin.zip"
  name "cc-pool Status"
