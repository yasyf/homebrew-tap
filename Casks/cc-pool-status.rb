...
cask "cc-pool-status" do
  version "0.61.5"
  sha256 "5688e8e0fd11db4c732e9f04ae42e691d51a7e87af19faf275a7617e283b4819" # app

  url "https://github.com/yasyf/cc-pool/releases/download/v0.61.5/cc-pool-status-v0.61.5-darwin.zip"
  name "cc-pool Status"
